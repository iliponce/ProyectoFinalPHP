...
Route::get('/proyectos', [Proyecto::class, 'index'])->name('proyectos.index');

Route::get('proyectos/reportePDF',[App\Http\Controllers\ProyectosController::class,'getPDF'])->name('proyectos/reportePDF');
